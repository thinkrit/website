...
type SmaaAssets = { smaa: { area?: HTMLImageElement; search?: HTMLImageElement } };
...
const Hyperspeed: FC<HyperspeedProps> = ({ effectOptions = DEFAULT_EFFECT_OPTIONS }) => {
  ...
  return <div data-hyperspeed-canvas className="h-full w-full [&_canvas]:h-full [&_canvas]:w-full" ref={hyperspeed} />;
};
