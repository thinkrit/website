...
import { getCopy, type Locale } from '@/lib/site-data'
      ...
      <section className="py-24 lg:py-28">
        <Container className="grid gap-10 md:grid-cols-[260px_1fr]">
          ...
          <div className="grid gap-12 lg:grid-cols-[1fr_440px]">
            <div className="text-2xl font-medium leading-snug text-zinc-950">
      ...
      <section className="pb-24 lg:pb-32">
        <Container className="grid gap-10 md:grid-cols-[260px_1fr]">
          ...
          <form className="max-w-5xl">
            <h2 className="max-w-3xl text-balance text-4xl font-medium leading-tight text-zinc-950 md:text-5xl">
