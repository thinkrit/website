    ...
    <>
      <HeroFrame compact locale={locale} shared={shared}>
        <div className="self-end">
          <SectionLabel label={fieldText(hero?.title, fallback.hero.label)} />
          <h1 className="mt-8 text-balance text-5xl font-medium leading-tight text-zinc-950 md:text-6xl">
            {fieldText(hero?.header, fallback.hero.title)}
          </h1>
          <div className="mt-12 border-l border-zinc-300 pl-8">
      ...
      <ProductSteps
        ...
        title={
          <>
            ...
            <HighlightedTitle
              className="mt-12 text-balance text-4xl font-medium leading-tight text-zinc-950 md:text-5xl"
      ...
      <section className="bg-zinc-950 py-20 text-white lg:py-24">
        <Container className="grid gap-12 lg:grid-cols-[360px_1fr]">
          ...
          <div>
            <h2 className="max-w-3xl text-balance text-4xl font-medium leading-tight text-white md:text-5xl">
